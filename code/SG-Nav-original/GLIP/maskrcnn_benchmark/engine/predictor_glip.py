...
from maskrcnn_benchmark.utils.hf_model_paths import resolve_hf_model_path

engine = inflect.engine()
_nltk_data_dir = os.environ.get(
    "SGNAV_NLTK_DATA", "/mnt/d/Habitat/data/nltk_data"
)
...
for _package, _resource in _nltk_resources.items():
    try:
    ...
    def build_tokenizer(self):
        ...
        if cfg.MODEL.LANGUAGE_BACKBONE.TOKENIZER_TYPE == "bert-base-uncased":
            tokenizer = AutoTokenizer.from_pretrained(
                resolve_hf_model_path("bert-base-uncased")
            )
